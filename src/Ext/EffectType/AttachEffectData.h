...
#include "Effect/AddByExistingData.h"
// State Effects
...
public:
	...
	EFFECT_VAR_DEFINE(AddByExisting);
	// State Effects
	...
	std::vector<std::string> GetScriptNames()
	{
		...
		EFFECT_VAR_SCRIPT_NAME(AddByExisting);
	...
	void ProcessEffects(T& stream)
	{
		stream
			...
			EFFECT_VAR_PROCESS(AddByExisting)
			// State Effects
